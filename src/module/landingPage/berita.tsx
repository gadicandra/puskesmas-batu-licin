...
const BeritaCard = ({ item }: { item: typeof DUMMY_DATA[0] }) => {
    return (
        <div className="bg-white border border-slate-100 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow duration-300 flex flex-col h-full">
            {/* Image Placeholder */}
            <div className="aspect-[4/3] bg-[#EAF8F2] rounded-lg flex flex-col items-center justify-center text-slate-600 mb-3 relative overflow-hidden group">
                ...
                {item.imageUrl ? (
                    ...
                    <>
                        ...
                        <span className="text-xs font-medium">Gambar artikel</span>
                    </>
                )}
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
                <div className="inline-flex items-center gap-1 bg-green-50 px-2 py-0.5 rounded-full">
                    <IoMdPricetag className="text-green-700 w-3 h-3" />
