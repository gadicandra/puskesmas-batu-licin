...
const DASAR =
    'w-full rounded-xl border border-primary/15 bg-white px-4 py-2.5 text-base text-primary placeholder:text-tertiary/60 transition focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary/30 disabled:bg-latar disabled:text-tertiary'
